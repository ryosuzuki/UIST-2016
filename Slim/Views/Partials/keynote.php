...
<div class="ui stackable grid">
  <div class="six wide column centered">
    <h1 style="margin: 0">Takeo Kanade</h1>
    <h3 style="margin-top: 0;">Carnegie Mellon University</h3>
    <img class="ui fluid image" src="<?php echo BASE_PATH; ?>/lib/img/keynote/takeo-kanade.jpg" alt="">
  </div>
  <div class="ten wide column centered">
    <h2 class="text text-spaced">Opening keynote</h2>
...
<div class="ui stackable grid">
  ...
  <div class="six wide column centered">
    <h1 style="margin: 0">Naoto Fukasawa</h1>
    <h3 style="margin-top: 0;">NAOTO FUKASAWA DESIGN</h3>
    <img class="ui fluid image" src="<?php echo BASE_PATH; ?>/lib/img/keynote/naoto-fukasawa.jpg" alt="">
  </div>
  <div class="ten wide column centered">
    <h2 class="text text-spaced">Closing keynote</h2>
    ...
    <a href="http://www.naotofukasawa.com/BIOGRAPHY/biography_home_e.html" target="_blank">Full bio</a>
    </div>
  </div>
</div>
