...
<div id="posters" class="ui stackable grid">
  <section class="twelve wide column centered">
    <h2 class="ui horizontal divider header">Accepted Posters</h2>
          ...
          <tr>
            <td>
              ...
              <p class="poster">
                ...
                <br>
                <span class="authors">
                  Hyunchul Lim, Jungmin Chung, Changhoon Oh, SoHyun Park, Bongwon Suh                </span>
                </p>
              </td>
            </tr>
          </tbody>
