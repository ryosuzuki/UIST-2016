...
<div class="ui stackable grid">
  <section class="twelve wide column centered">
    <h2 class="ui horizontal divider header">Submission</h2>
...
<div class="ui stackable grid">
  <section id="topics" class="twelve wide column centered">
    <h2 class="ui horizontal divider header">Appropriate Topics</h2>
    <div class="ui stackable grid detail">
      <div class="fourteen wide column centered">
        <div class="text">
...
<div class="ui stackable grid">
  <section id="links" class="twelve wide column centered">
    <h2 class="ui horizontal divider header">Additional References</h2>
    <div class="ui stackable grid detail">
      <div class="fourteen wide column centered">
        <div class="about text">
    <ul>
      <li><a href="<?php echo BASE_PATH; ?>/call">Call for Participation</a></li>
      <li><a href="<?php echo BASE_PATH; ?>/author-guide">Author's Guide</a></li>
      <li><a href="<?php echo BASE_PATH; ?>/author-advice">Advice for a Successful UIST Submission</a></li>
    </ul>
    </div>
  </section>
</div>
