...
<div class="ui stackable grid">
  ...
  <h2 class="ui horizontal divider header">Call for Student Innovation Contest</h2>
  ...
  <div class="text">
    The simplest demo you can build is one that renders a virtual event into a
    physical event, for instance a mobile phone game in which you actually steer
    an airplane against the wind (spoiler alert: we've done this one, check out
    the <a href="https://www.youtube.com/watch?v=swmGaGT8lvs">video here</a>). Because using EMS makes interfaces more physical, when the
    wind comes one of the player's wrists contracts (using the muscle stimulation)
    and turns the airplane into an undesired direction, thus the player must turn
    against the force-feedback and steer the airplane into safety! <strong>What other
    futuristic mobile apps can you make that use EMS?</strong> A more compelling demo
    that you can build takes place in Virtual Reality, what could you improve in
    the experience of virtual reality if the user could feel forces? Check this
    <a href="https://www.youtube.com/watch?v=k5e4mXQLq54">video example</a> for inspiration, here you see Virtual Reality sport simulators
    such as boxing and baseball that actually deliver a force. Here we combined
    the EMS bracelet with a solenoid... <strong>what other novel techniques and devices
    can you combine EMS with?</strong> You can even combine it with everyday items and make
    them smarter: what if while the user is manipulating an object you could actuate
    and change the way they physically handle the object? Check this <a href="https://www.youtube.com/watch?v=Gz4dphzBb6I">video for
    inspiration in which we made a spray can shake by itself</a>. <strong>Think outside the
    box and create novel interfaces that take advantage of these physical
    sensations for augmented or virtual reality</strong> or maybe you don't even need
    screens! The more exciting your demo gets the higher are the chances for
