...
<div class="ui stackable grid">
  ...
  <h2>Paper Length and Presentation Time</h2>
  <div class="text">
    Papers are of variable length. Paper length must be based on the size of the contribution. A new idea presented in a compact format is more likely to be accepted than the same idea in a long format. Exceptionally long papers (more than 10 pages) need to include very strong contributions to warrant acceptance. Shorter, focused papers (called Tech Notes in years prior to 2011) are still an appropriate submission length for UIST. Papers with length disproportionate to their contribution will be rejected. In rare cases, authors may be requested to shorten papers in a camera-ready, for example by removing sections that detract from a paper’s main contribution.
  ...
  <div class="text">
    When you submit your work, you will be asked to agree to the terms and conditions of the <a href="https://chi2016.acm.org/wp/sigchi-submitter-agreement/" target="_blank">SIGCHI Submitter Agreement</a>. In addition, the author list must be complete by the submission deadline. Late author changes require approval from Program Chairs and may be declined or require paper withdrawal because of reviewing conflicts.
  </div>
  ...
  <div class="text">
    The submission of supplementary videos is strongly encouraged. Especially in cases of interactive techniques or systems, videos play an important role in convincing reviewers that the contribution described works and works well. Videos should be no more than five minutes long and the total size of a submission (including the paper) is limited to 100 MB. See the <a href="http://uist.acm.org/uist2016/video-guide" target="_blank">video guide</a> for details.
  </div>
  ...
  <div class="text">
    Video previews are 30-second clips that are used to describe and showcase a paper before, during, and after the conference. <u>Video previews are mandatory accompanying material for all papers that will be presented at UIST.</u> Please carefully read the <a href="http://uist.acm.org/uist2016/video-previews" target="_blank">Video Preview instructions</a> and submit your Video Preview in the dedicated "Video Preview" field of your final submission at <a href="http://www.precisionconference.com/~sighchi"  target="_blank">http://www.precisionconference.com/~sighchi</a>.
  </div>
  ...
  <div class="text">
    All paper submissions must be made in the <b><u>2014</u></b> version of the <a href="http://www.sigchi.org/publications/chipubform" target="_blank">SIGCHI papers format</a>. (Note that this format utilizes the “Lastname, F.M.” author-name reference style, not the more recent “Firstname M. Lastname” convention.)
  </div>
