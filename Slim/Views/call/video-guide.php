  ...
  <section id="call" class="twelve wide column centered">
    ...
    <div class="ui stackable grid detail">
      <div class="fourteen wide column centered">
        ...
        <h3>The tips we provide are organized into the following sections</h3>
        <div class="text">
          <ul>
            <li>Planning Before You Shoot</li>
            <li>Pacing</li>
            <li>Content: Exposition and Presentation</li>
            <li>Equipment</li>
            <li>Camera Basics</li>
            <li>Lighting</li>
            <li>Sound/Audio</li>
            <li>Editing</li>
            <li>Capturing and Recording information on Computer Screens</li>
            <li>Creating Digital Video Files</li>
            <li>Final Thought</li>
          </ul>
        </div>

        <h2>PLANNING BEFORE YOU SHOOT</h2>
        <div class="text">
        ...
        <h2>CONTENT: EXPOSITION AND PRESENTATION</h2>
        <div class="text">
        ...
        <h2>CAPTURING AND RECORDING INFORMATION ON COMPUTER SCREENS</h2>
        <div class="text">
        ...
        <h2>CREATING DIGITAL VIDEO FILES</h2>
        <div class="text">
